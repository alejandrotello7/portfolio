      ...
      experiences: [
        {
          ...
          description: [
            "Implemented infrastructure automation pipelines using Gitlab CI/CD for streamlined deployments.",
            "Utilized Infrastructure as Code (IaC) tools like Terraform and Ansible for efficient provisioning of infrastructure.",
            "Engineered and maintained cloud infrastructure on AWS and Azure to support client requirements.",
            "Developed and orchestrated Kubernetes clusters and facilitated application containerization with Docker.",
          ],
          color: "#0879bf",
        },
        {
